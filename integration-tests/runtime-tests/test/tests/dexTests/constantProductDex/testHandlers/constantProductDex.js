...
exports.getOwnerFee = exports.getUserTokens = exports.swapTokenPairs = exports.removeLiquidityFromPool = exports.sellToPool = exports.buyFromPool = exports.addFundstoThePool = exports.createPool = exports.mintAssets = void 0;
...
async function mintAssets(walletId, assetId, amount) {
    const { data: [result], } = await (0, polkadotjs_1.sendAndWaitForSuccess)(api, walletAlice, api.events.sudo.Sudid.is, api.tx.sudo.sudo(api.tx.assets.mintInto(assetId, walletId.publicKey, amount)));
    return result;
}
